...
var Message = function (_Component) {
  ...
  Message.prototype.render = function render() {
    var contentClassList = ['sc-message--content', this.props.message.author === this.props.me ? 'sent' : 'received'];

    var isSent = this.props.message.author === this.props.me;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('div', { className: 'sc-message--avatar ' + (this.props.message.author == "Kenny Rogers" ? "kenny" : "") + ' ' + (isSent ? "me" : "") }),
        _react2.default.createElement(
          'div',
          { className: 'sc-message--name' },
